(function($)
{
    ...
    $(document).ready( function()
    {
        ...
        $(document).on('click', '.bnktc_booking_popup_btn', function (e)
        {
            ...
            data['_ajax_nonce'] = window.BookneticData.ajax_nonce;
            ...
            var ajaxObject =
            {
                ...
                success: function ( result )
                {
                    ...
                    result.filter('link[rel="stylesheet"]').each(function() {
                    ...
                    let panel = result.not('link[rel="stylesheet"]');

                    if( tenantId > 0 ){
                        panel.data('tenant_id', tenantId);
                    }

                    modalX.css('display', 'flex');
                    modalBody.empty().append( panel );
                },
